...
// const filterResults = (genreIds) => {
//     const filteredMovies = moviesData.filter((movie) => {
//         for (let i = 0; i < genreIds.length; i++ ) {
//             movie.genre_ids
//         }
//         return movie.genre_ids.some((item) => item === genreIds);
//     });
//     return filteredMovies.length;
// };

// console.log(filterResults(28, 80));
...
const filterArrays = (genreIds, filteredArray) => {
    return genreIds.every((item) => filteredArray.includes(item));
};

console.log("array)", filterArrays(genreIds, array));
console.log("array2)", filterArrays(genreIds, array2));
console.log("array3);)", filterArrays(genreIds, array3));
